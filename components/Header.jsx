...
import { SearchIcon, MenuIcon, UserCircleIcon, UserIcon, GlobeIcon, GlobeAltIcon, UsersIcon } from '@heroicons/react/solid' 
...
function Header({placeholder}) {
    ...
    return (
        ...
        <div onClick={() => router.push('/')} className="relative flex items-center h-10 cursor-pointer my-auto">
            ...
            <div> 
                <Image 
                src="https://mb.cision.com/Public/15142/2205445/a513362fe1243701_org.png"
                layout="fill"
                objectFit="contain" 
                objectPosition="left"
                priority="true"
